...
@implementation NSString (HLUtil)
...
@implementation UIDevice (HLUtil)

/// 获取系统大中小版本号
+ (uint32_t)systemMajorVersion;
{
    NSArray *vArray = [[UIDevice systemVersion] componentsSeparatedByString:@"."];
    return vArray.count>0 ? [vArray[0] intValue] : 0;
}

+ (uint32_t)systemMinorVersion;
{
    NSArray *vArray = [[UIDevice systemVersion] componentsSeparatedByString:@"."];
    return vArray.count>1 ? [vArray[1] intValue] : 0;
}

+ (uint32_t)systemMicroVersion
{
    NSArray *vArray = [[UIDevice systemVersion] componentsSeparatedByString:@"."];
